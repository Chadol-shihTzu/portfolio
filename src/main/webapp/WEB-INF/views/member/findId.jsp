   ...
   <div class="row">
      ...
      <div class="col-xl-6 p-5 border">
	      <div class="d-flex justify-content-between">
	      	<h5 class="md-5">아이디 찾기</h5>
		      	<div class="btn-group">
						<a class="btn btn-outline-warning" href="${path}" style="height:38px">Home</a>
				</div>
			</div>
      	
      	<form method="post" class="mt-5" autocomplete="off" id="emailForm">
      		<div class="input-group mb-3">
      			<input type="text" class="form-control" placeholder="생년월일 입력" id="userBirth" name="userBirth" required="required">
      		</div>
