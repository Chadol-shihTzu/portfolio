...
<div class="container">
   <div class="row">
      <div class="col-md-12">
		...
		<main>
		    <form method="post" action="${path}/board/paint/replyModify">
				<p class="input-group">
				...
				<div class="d-flex justify-content-end my-3 ">
					<div class="btn-group">
						<a href="${path}/board/paint/paintView?paintNo=${reply.paintNo}" class="btn btn-outline-danger" >취소</a>
						<input type="hidden" name="paintNo" value="${reply.paintNo}"/>
						<input type="hidden" name="paintRno" value="${reply.paintRno}"/>
