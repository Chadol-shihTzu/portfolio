    	...
    	<c:if test="${member != null}">
      	...
      	<div class="mb-2" style="width:344px;">
      		<div class="input-group mb-3">
		    	...
		    	<input type="text" class="form-control" id="recommendNo" value="${delete}" name="recommendNo">
		    </div>
 ...
 <script>
  ...
  // 폼을 변수에 저장
	    ...
	    $("#cancel_btn").click(function(){   
	     formObj.attr("action", "/jdh/board/recommend/recommendView?recommendNo=" + $("#recommendNo").val());
