...
<div class="container">
   <div class="row">
      <div class="col-md-12">
		...
		<main>
		    <form method="post" action="${path}/board/recommend/replyModify">
				<p class="input-group">
				...
				<div class="d-flex justify-content-end my-3 ">
					<div class="btn-group">
						<a href="${path}/board/recommend/recommendView?recommendNo=${reply.recommendNo}" class="btn btn-outline-danger" >취소</a>
						<input type="hidden" name="recommendNo" value="${reply.recommendNo}"/>
						<input type="hidden" name="recommendRno" value="${reply.recommendRno}"/>
