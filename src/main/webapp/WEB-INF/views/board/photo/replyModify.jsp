...
<div class="container">
   <div class="row">
      <div class="col-md-12">
		...
		<main>
		    <form method="post" action="${path}/board/photo/replyModify">
				<p class="input-group">
				...
				<div class="d-flex justify-content-end my-3 ">
					<div class="btn-group">
						<a href="${path}/board/photo/photoView?photoNo=${reply.photoNo}" class="btn btn-outline-danger" >취소</a>
						<input type="hidden" name="photoNo" value="${reply.photoNo}"/>
						<input type="hidden" name="photoRno" value="${reply.photoRno}"/>
