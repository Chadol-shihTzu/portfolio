...
>
		...
		<main>
		    <form method="post" action="${path}/board/literature/essay/replyModify">
				<p class="input-group">
				...
				<div class="d-flex justify-content-end my-3 ">
					<div class="btn-group">
						<a href="${path}/board/literature/essay/essayView?essayNo=${reply.essayNo}" class="btn btn-outline-danger" >취소</a>
						<input type="hidden" name="essayNo" value="${reply.essayNo}"/>
						<input type="hidden" name="essayRno" value="${reply.essayRno}"/>
