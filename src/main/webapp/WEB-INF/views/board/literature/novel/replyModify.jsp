...
<div class="container">
   <div class="row">
      <div class="col-md-12">
		...
		<main>
		    <form method="post" action="${path}/board/literature/novel/replyModify">
				<p class="input-group">
				...
				<div class="d-flex justify-content-end my-3 ">
					<div class="btn-group">
						<a href="${path}/board/literature/novel/novelView?novelNo=${reply.novelNo}" class="btn btn-outline-danger" >취소</a>
						<input type="hidden" name="novelNo" value="${reply.novelNo}"/>
						<input type="hidden" name="novelRno" value="${reply.novelRno}"/>
