...
<div class="container">
   <div class="row">
      <div class="col-md-12">
		...
		<main>
		    <form method="post" action="${path}/board/literature/poem/replyModify">
				<p class="input-group">
				...
				<div class="d-flex justify-content-end my-3 ">
					<div class="btn-group">
						<a href="${path}/board/literature/poem/poemView?poemNo=${reply.poemNo}" class="btn btn-outline-danger" >취소</a>
						<input type="hidden" name="poemNo" value="${reply.poemNo}"/>
						<input type="hidden" name="poemRno" value="${reply.poemRno}"/>
