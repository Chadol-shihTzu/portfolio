...
<div class="container">
   <div class="row">
      <div class="col-md-12">
		...
		<main>
		    <form method="post" action="${path}/board/literature/criticism/replyModify">
				<p class="input-group">
				...
				<div class="d-flex justify-content-end my-3 ">
					<div class="btn-group">
						<a href="${path}/board/literature/criticism/criticView?criticNo=${reply.criticNo}" class="btn btn-outline-danger" >취소</a>
						<input type="hidden" name="criticNo" value="${reply.criticNo}"/>
						<input type="hidden" name="criticRno" value="${reply.criticRno}"/>
