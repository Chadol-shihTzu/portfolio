...
public class dramaBoardDAOImpl implements dramaBoardDAO{
	...
	private static String namespace = "dramaboard";
	...
	public dramaBoardVO view(int dramaNo) throws Exception {
		return sql.selectOne(namespace+".view", dramaNo);
	}
	...
	public void delete(int dramaNo) throws Exception {
		sql.delete(namespace + ".delete", dramaNo);
	...
	public void boardHit(int dramaNo) throws Exception {
		sql.update(namespace + ".boardHit", dramaNo);
