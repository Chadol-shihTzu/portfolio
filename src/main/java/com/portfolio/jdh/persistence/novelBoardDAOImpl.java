...
@Repository
public class novelBoardDAOImpl implements novelBoardDAO{
	
	@Inject
	private SqlSession sql;
	
	private static String namespace = "novelboard";
	...
	public novelBoardVO view(int novelNo) throws Exception {
		return sql.selectOne(namespace+".view", novelNo);
	}
	...
	public void delete(int novelNo) throws Exception {
		sql.delete(namespace + ".delete", novelNo);
	...
	public void boardHit(int novelNo) throws Exception {
		sql.update(namespace + ".boardHit", novelNo);
