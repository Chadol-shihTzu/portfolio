...
public class essayBoardDAOImpl implements essayBoardDAO{
	...
	private static String namespace = "essayboard";
	...
	//게시물 조회
	@Override
	public essayBoardVO view(int essayNo) throws Exception {
		return sql.selectOne(namespace+".view", essayNo);
	}
	...
	public void delete(int essayNo) throws Exception {
		sql.delete(namespace + ".delete", essayNo);
	...
	//게시판 조회수
	@Override
	public void boardHit(int essayNo) throws Exception {
		sql.update(namespace + ".boardHit", essayNo);
