...
public class paintBoardDAOImpl implements paintBoardDAO{
	...
	private static String namespace = "paintboard";
	
	//게시물 작성
	@Override
	public void write(paintBoardVO vo) throws Exception {
		sql.insert("paintboard.write", vo);
	}
	//게시물 리스트
	@Override
	...
	public paintBoardVO view(int paintNo) throws Exception {
		return sql.selectOne(namespace+".view", paintNo);
	}
	...
	public void delete(int paintNo) throws Exception {
		sql.delete(namespace + ".delete", paintNo);
	...
	public void boardHit(int paintNo) throws Exception {
		sql.update(namespace + ".boardHit", paintNo);
