...
@Repository
public class poemBoardDAOImpl implements poemBoardDAO{
	
	@Inject
	private SqlSession sql;
	
	private static String namespace = "poemboard";
	...
	public poemBoardVO view(int poemNo) throws Exception {
		return sql.selectOne(namespace+".view", poemNo);
	}
	...
	public void delete(int poemNo) throws Exception {
		sql.delete(namespace + ".delete", poemNo);
	...
	public void boardHit(int poemNo) throws Exception {
		sql.update(namespace + ".boardHit", poemNo);
