...
public class photoBoardDAOImpl implements photoBoardDAO{
	...
	private static String namespace = "photoboard";
	
	//게시물 작성
	@Override
	public void write(photoBoardVO vo) throws Exception {
		sql.insert("photoboard.write", vo);
	}
	//게시물 리스트
	@Override
	...
	public photoBoardVO view(int photoNo) throws Exception {
		return sql.selectOne(namespace+".view", photoNo);
	}
	...
	public void delete(int photoNo) throws Exception {
		sql.delete(namespace + ".delete", photoNo);
	...
	public void boardHit(int photoNo) throws Exception {
		sql.update(namespace + ".boardHit", photoNo);
